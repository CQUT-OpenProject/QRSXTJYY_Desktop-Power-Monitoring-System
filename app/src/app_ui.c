...
{
    /* 主菜单只有两项：第 0 项进入 PWM 页，第 1 项进入测频页。 */
    s_state.page = s_state.cursor == 0U ? APP_UI_PAGE_PWM : APP_UI_PAGE_MEASURE;
    s_state.cursor = 0U;
    s_state.editing = 0U;
}
